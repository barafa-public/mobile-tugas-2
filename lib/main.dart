...
void hitungTambahKurang() {
  ...
  double? angka1 = bacaAngka("Masukkan angka pertama: ");
  double? angka2 = bacaAngka("Masukkan angka kedua: ");
...
// FUNGSI BANTU: Baca dan validasi input angka (double)
// =========================================================
double? bacaAngka(String label) {
  stdout.write(label);
  ...
  // Terima koma sebagai pemisah desimal juga (gaya Indonesia)
  String cleaned = raw.trim().replaceAll(',', '.');

  double? angka = double.tryParse(cleaned);
  if (angka == null) {
    print("Input tidak valid! Harap masukkan angka (contoh: 12, -5, 3.14).\n");
    return null;
  }
